    ...
    def double(self):
        ...
        if self.is_container:
            if not self.doubled:
                self.damage *= 2
                self.doubled = True
            if self.ant_contained and not self.ant_contained.doubled:
                self.ant_contained.damage *= 2
                self.ant_contained.doubled = True
        elif not self.doubled:
            self.damage *= 2
            self.doubled = True
        # END Problem 12
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        # BEGIN Problem 3 return random_bee(self.place.bees) # REPLACE THIS LINE
        # END Problem 3 and 4
...
class QueenAnt(ThrowerAnt):
    ...
    def action(self, gamestate):
        ...
        move_place = self.place.exit
        while move_place:
            if move_place.ant:
                move_place.ant.double()
            move_place = move_place.exit
